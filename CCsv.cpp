...
void CCsv::write_csv(std::string filename, std::vector<std::pair<std::string, std::vector<int>>> dataset) {
	...
	//   as std::pair<std::string, std::vector<
	// >>
...
//Ben Gorman, "Reading And Writing CSV Files With C++", GormAnalysis, https://www.gormanalysis.com/blog/reading-and-writing-csv-files-with-cpp/, (2023/02/02â{óó)ÅD